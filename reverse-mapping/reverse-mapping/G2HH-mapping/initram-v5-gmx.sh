...
NBSTEPS=500000
MDSTEPS=500000
DT=0.00001,0.0001,0.0005,0.001
MDP=()
POSRE=true
...
B="python2 $SDIR/backward.py -f $INP -raw $RAW -o $GRO -kick $KICK -sol -p $TOP -po $OTP -n $NDX -from $CG -to $AA"
echo $B; $B || exit
