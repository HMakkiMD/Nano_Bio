...
if seq != []:
    print('File "product_modified.gro" cannot be completely modified.')
    print('Beads '+f'{seq2line.split()[0]}'+' to '+f'{seq2line.split()[-1]}'+' do not match with any blocks.')
    print('Check bead names in "itp", "gro" and "map" files.')
    exit()
